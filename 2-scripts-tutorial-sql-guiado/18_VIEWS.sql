...
OBJETIVO:
Salvar uma consulta como objeto reutilizável (camada de leitura).

QUANDO USAR:
- Reuso de consultas (padronização)
...
-- Exemplo (didático):
-- CREATE OR ALTER VIEW SalesLT.vw_PedidosPorCliente AS
-- SELECT CustomerID, COUNT(*) AS QtdPedidos
-- FROM SalesLT.SalesOrderHeader
-- GROUP BY CustomerID;

--1. Introdu��o: Criando uma VIEW
...
--2. Criar uma View para mostrar as informa��es do cliente:
