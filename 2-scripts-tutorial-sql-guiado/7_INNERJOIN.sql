...
OBJETIVO:
Combinar linhas de duas tabelas retornando apenas as correspondências.

QUANDO USAR:
- Relatórios com relacionamento obrigatório
- Análises com integridade (somente registros relacionados)
...
-- Exemplo:
-- SELECT TOP 10 c.CustomerID, c.FirstName, soh.SalesOrderID
-- FROM SalesLT.Customer c
-- INNER JOIN SalesLT.SalesOrderHeader soh
--   ON soh.CustomerID = c.CustomerID;

--Retornar as TOP 10 categorias com maior totaliza��o de vendas
