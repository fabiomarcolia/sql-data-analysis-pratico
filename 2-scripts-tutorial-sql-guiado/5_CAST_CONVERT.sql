/*
COMANDOS: CAST / CONVERT

OBJETIVO:
Converter tipos de dados (texto → número, data → texto, etc.).

QUANDO USAR:
- Corrigir tipos incompatíveis em operações
- Formatar saídas
- Evitar erros de comparação/cálculo
...
-- Exemplo:
-- SELECT CAST(ListPrice AS INT) AS ListPrice_Int
